          ...
          >
            <PinContainer title={item.title} href={item.link}>
              ...
              >
                ...
                <h1 className="text-xl font-bold mb-2 lg:text-2xl md:text-xl line-clamp-1 bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 bg-opacity-50">
                  {item.title}
                </h1>
